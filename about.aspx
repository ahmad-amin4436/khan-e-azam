   ...
   <asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <section class="relative w-full flex items-center justify-center overflow-hidden" style="height: 80vh;">
        ...
        <img src="https://images.unsplash.com/photo-1504674900247-0877df9cc836?w=1600&q=80"
             ...
             style="top: 0; left: 0; filter: blur(6px); transform: scale(1.05);" alt="" />

        <!-- Dark tint overlay -->
        <div class="absolute w-full h-full z-0" style="top: 0; left: 0; background-color: rgba(0,0,0,0.4);"></div>

        <!-- Glassmorphism Content Box -->
        <div class="relative z-10 text-center" style="width: 90%; max-width: 1200px; padding: 64px 32px; background-color: rgba(0,0,0,0.4); backdrop-filter: blur(8px); border: 1px solid rgba(255,255,255,0.1); border-radius: 24px; box-shadow: 0 25px 50px -12px rgba(0,0,0,0.5);">
            <h1 class="font-lobster font-normal mb-6 text-white" style="font-size: clamp(3rem, 6vw, 5rem); line-height: 1.2;">
                The Story Behind<br />
                <span style="color: #C89B3C;">Khan-e-Azam</span>
            </h1>

            <p class="mx-auto" style="color: rgba(255,255,255,0.8); font-size: 18px; line-height: 1.8; max-width: 700px;">
            ...
            <div class="flex flex-col lg:flex-row items-center" style="gap: 40px;">
                ...
                <div class="w-full lg:w-1/2">
                    <div class="relative overflow-hidden shadow-lg" style="border-radius: 20px;">
                        <img src="/assets/images/about/our-story.jpg" class="w-full h-auto" alt="Culinary Heritage">
                    </div>
                </div>
