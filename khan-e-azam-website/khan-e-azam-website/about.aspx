...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
  ...
  <section class="relative w-full flex items-center justify-center overflow-hidden" style="height: 80vh;">
    ...
    <img src="https://images.unsplash.com/photo-1504674900247-0877df9cc836?w=1600&q=80"
         class="absolute w-full h-full object-cover z-0" style="top: 0; left: 0; filter: blur(6px) brightness(0.7); transform: scale(1.05);" alt="" />
    <div class="absolute w-full h-full z-0" style="top: 0; left: 0; background-color: rgba(0,0,0,0.55);"></div>

    <!-- Glassmorphism Content Box -->
    <!-- Added 'py-12' and 'my-auto' to ensure vertical spacing -->
    <div class="relative z-10 text-center glass-hero-box" style="width: 90%; max-width: 1200px; padding: 40px 20px; background-color: rgba(16,12,8,0.55); backdrop-filter: blur(8px); border: 1px solid rgba(255,255,255,0.1); border-radius: 24px; box-shadow: 0 25px 50px -12px rgba(0,0,0,0.5);">

        <h1 class="font-lobster font-normal mb-4 text-white hero-title" style="font-size: clamp(2rem, 5vw, 5rem); line-height: 1.1;">
            The Story Behind<br />
            <span style="color: #FFD200;">Khan-e-Azam</span>
        </h1>
    ...
    <!-- Our Story Section -->
    <section class="kea-stars" style="padding: 80px 0; background-color: var(--dark-1);">
        <div class="container mx-auto px-6" style="max-width: 1200px;">
            <div class="flex flex-col lg:flex-row items-center" style="gap: 40px;">
                ...
                <!-- Text Column -->
                <div class="w-full lg:w-1/2">
                    <h5 class="uppercase mb-3" style="color: #0D5B3E; letter-spacing: 3px; font-size: 0.8rem;">Our Story</h5>
                    <h2 class="font-lobster font-bold mb-6" style="color: var(--light-text); font-size: 2.3rem; line-height: 1.2;">
                        A Legacy Crafted With<br />
                        <span style="color: #0D5B3E;">Royalty &amp; Passion</span>
                    </h2>
                    <p class="mb-6" style="color: var(--muted-text); line-height: 1.9;">
                    ...
                    <div class="w-full" style="margin-top: 50px;">
                        <a href="/Pages/Menu.aspx" class="btn btn-md btn-hover-1" style="background-color: #0D5B3E; color: #fff; border: 1px solid #0D5B3E;">
                            <span>EXPLORE OUR MENU</span>
                        </a>
                    </div>

                    <hr style="border: none; border-top: 1px solid var(--dark-border); margin: 32px 0;">

                    <div class="flex items-center text-center">
                        <div class="flex-1" style="border-right: 1px solid var(--dark-border);">
                            <div class="font-lobster text-[2rem] font-bold mb-1" style="color: #0D5B3E;">35+</div>
                            <div class="uppercase tracking-[2px]" style="font-size: 0.7rem; color: var(--muted-text);">Years of Legacy</div>
                        </div>
                        <div class="flex-1" style="border-right: 1px solid var(--dark-border);">
                            <div class="font-lobster text-[2rem] font-bold mb-1" style="color: #0D5B3E;">120+</div>
                            <div class="uppercase tracking-[2px]" style="font-size: 0.7rem; color: var(--muted-text);">Signature Dishes</div>
                        </div>
                        <div class="flex-1">
                            <div class="font-lobster text-[2rem] font-bold mb-1" style="color: #0D5B3E;">50K+</div>
                            <div class="uppercase tracking-[2px]" style="font-size: 0.7rem; color: var(--muted-text);">Happy Guests</div>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <!-- Standard Section -->
    <section class="relative bg-black overflow-hidden kea-stars" style="padding: 80px 0;">
        <!-- Background Elements -->
        <img src="/assets/images/about/standard-bg.jpg" class="absolute w-full h-full object-cover" style="top: 0; left: 0; opacity: 0.7;" alt="">
        <div class="absolute w-full h-full" style="top: 0; left: 0; background: linear-gradient(to bottom, rgba(0,0,0,0.8), rgba(16,12,8,0.95));"></div>

        <!-- Content Container -->
        <div class="container mx-auto text-center relative z-10 px-6">
            <h6 class="uppercase mb-3" style="color: #0D5B3E; letter-spacing: 4px; font-size: 0.8rem;">The Standard</h6>
            ...
            <div class="flex flex-wrap" style="gap: 24px;">
                <!-- Card 1 -->
                <a href="#" class="block" style="flex: 1 1 280px; text-decoration: none; background: rgba(255,255,255,0.05); border: 1px solid rgba(13,91,62,0.3); padding: 32px; border-radius: 20px; box-shadow: 0 20px 25px -5px rgba(0,0,0,0.3); transition: all 0.5s ease;"
                   onmouseover="this.style.background='rgba(13,91,62,0.1)'; this.style.borderColor='#0D5B3E'; this.style.transform='translateY(-8px)'; this.querySelector('.std-icon').style.color='#fff';"
                   onmouseout="this.style.background='rgba(255,255,255,0.05)'; this.style.borderColor='rgba(13,91,62,0.3)'; this.style.transform='translateY(0)'; this.querySelector('.std-icon').style.color='#0D5B3E';">
                    <div class="std-icon mb-4" style="font-size: 2rem; color: #0D5B3E; transition: color 0.5s ease;"><i class="fas fa-feather-alt"></i></div>
                ...
                <a href="#" class="block" style="flex: 1 1 280px; text-decoration: none; background: rgba(255,255,255,0.05); border: 1px solid rgba(13,91,62,0.3); padding: 32px; border-radius: 20px; box-shadow: 0 20px 25px -5px rgba(0,0,0,0.3); transition: all 0.5s ease;"
                   onmouseover="this.style.background='rgba(13,91,62,0.1)'; this.style.borderColor='#0D5B3E'; this.style.transform='translateY(-8px)'; this.querySelector('.std-icon').style.color='#fff';"
                   onmouseout="this.style.background='rgba(255,255,255,0.05)'; this.style.borderColor='rgba(13,91,62,0.3)'; this.style.transform='translateY(0)'; this.querySelector('.std-icon').style.color='#0D5B3E';">
                    <div class="std-icon mb-4" style="font-size: 2rem; color: #0D5B3E; transition: color 0.5s ease;"><i class="fas fa-leaf"></i></div>
                ...
                <a href="#" class="block" style="flex: 1 1 280px; text-decoration: none; background: rgba(255,255,255,0.05); border: 1px solid rgba(13,91,62,0.3); padding: 32px; border-radius: 20px; box-shadow: 0 20px 25px -5px rgba(0,0,0,0.3); transition: all 0.5s ease;"
                   onmouseover="this.style.background='rgba(13,91,62,0.1)'; this.style.borderColor='#0D5B3E'; this.style.transform='translateY(-8px)'; this.querySelector('.std-icon').style.color='#fff';"
                   onmouseout="this.style.background='rgba(255,255,255,0.05)'; this.style.borderColor='rgba(13,91,62,0.3)'; this.style.transform='translateY(0)'; this.querySelector('.std-icon').style.color='#0D5B3E';">
                    <div class="std-icon mb-4" style="font-size: 2rem; color: #0D5B3E; transition: color 0.5s ease;"><i class="fas fa-crown"></i></div>
    ...
    <section class="kea-stars" style="padding: 80px 0; background-color: var(--dark-1);">
        <div class="container mx-auto text-center px-6" style="max-width: 700px;">
            <div class="mb-4" style="font-size: 1.5rem; color: #FFD200;">
                <i class="fas fa-star"></i> <i class="fas fa-star"></i> <i class="fas fa-star"></i>
            </div>
            <h3 class="italic mb-6 font-lobster text-[1.75rem]" style="color: var(--light-text);">
                "A meal at Khan-e-Azam is more than just dining; it is a celebration of heritage."
            </h3>
            <p class="uppercase" style="letter-spacing: 2px; font-size: 0.9rem; color: var(--muted-text); margin-bottom: 32px;">We invite you to be part of our story.</p>
            <div class="w-full" style="margin-top: 30px;">
                <a href="/Contact.aspx" class="btn btn-md btn-hover-1" style="background-color: #0D5B3E; color: #fff; border: 1px solid #0D5B3E;">
                    <span>Visit Us</span>
                </a>
            </div>
        </div>
