<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TodaysSpecials.aspx.cs" Inherits="KhanEAzam.Admin.TodaysSpecials" MasterPageFile="~/Admin/Admin.Master" ValidateRequest="false" %>
<asp:Content ContentPlaceHolderID="PageTitle" runat="server">Today's Specials</asp:Content>
<asp:Content ContentPlaceHolderID="PageHeading" runat="server">Today's Specials</asp:Content>
<asp:Content ContentPlaceHolderID="MainContent" runat="server">
    ...
    <asp:Panel ID="pnlForm" runat="server" Visible="false">
        <div class="card">
            <div class="card-header"><asp:Label ID="lblFormTitle" runat="server">Add Special</asp:Label></div>
            <div class="card-body">
