<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="IconFeatures.aspx.cs" Inherits="KhanEAzam.Admin.IconFeatures" MasterPageFile="~/Admin/Admin.Master" ValidateRequest="false" %>
<asp:Content ContentPlaceHolderID="PageTitle" runat="server">Icon Features</asp:Content>
<asp:Content ContentPlaceHolderID="PageHeading" runat="server">Icon Features</asp:Content>
<asp:Content ContentPlaceHolderID="MainContent" runat="server">
    ...
    <asp:Panel ID="pnlForm" runat="server" Visible="false">
        <div class="card">
            <div class="card-header"><asp:Label ID="lblFormTitle" runat="server">Add Icon Feature</asp:Label></div>
            <div class="card-body">
                <asp:HiddenField ID="hfId" runat="server" Value="0" />
                <div class="row">
                    <div class="col-md-6 form-group"><label>Icon Class (flaticon/fa)</label><asp:TextBox ID="txtIconClass" runat="server" CssClass="form-control" placeholder="flaticon-discount" /></div>
                    <div class="col-md-6 form-group"><label>Title</label><asp:TextBox ID="txtTitle" runat="server" CssClass="form-control" /></div>
                    ...
                    <div class="col-md-6 form-group"><label>Link URL</label><asp:TextBox ID="txtLinkUrl" runat="server" CssClass="form-control" placeholder="#" /></div>
                    <div class="col-md-3 form-group"><label>Sort Order</label><asp:TextBox ID="txtSortOrder" runat="server" CssClass="form-control" Text="0" /></div>
                    <div class="col-md-3 form-group"><label>Active</label><br /><asp:CheckBox ID="chkIsActive" runat="server" Checked="true" Text=" Active" /></div>
                </div>
