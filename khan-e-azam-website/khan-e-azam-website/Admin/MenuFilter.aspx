        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <div class="row">
                    ...
                    <div class="col-md-8 form-group"><label>Filter Tags <small class="text-muted">(space-separated, e.g. All pizza sweet)</small></label><asp:TextBox ID="txtFilterTags" runat="server" CssClass="form-control" /></div>
