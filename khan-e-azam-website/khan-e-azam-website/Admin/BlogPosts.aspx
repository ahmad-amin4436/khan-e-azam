        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <div class="row">
                    ...
                    <div class="col-md-8 form-group"><label>Image Path</label><asp:TextBox ID="txtImage" runat="server" CssClass="form-control" placeholder="assets/images/blog/1.jpg" /></div>
                    <div class="col-md-8 form-group"><label>Video URL (optional)</label><asp:TextBox ID="txtVideo" runat="server" CssClass="form-control" /></div>
