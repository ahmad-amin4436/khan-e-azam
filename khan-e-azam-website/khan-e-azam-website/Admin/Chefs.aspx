        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <div class="row">
                    ...
                    <div class="col-md-12 form-group"><label>Image Path</label><asp:TextBox ID="txtImage" runat="server" CssClass="form-control" placeholder="assets/images/chef/1.jpg" /></div>
